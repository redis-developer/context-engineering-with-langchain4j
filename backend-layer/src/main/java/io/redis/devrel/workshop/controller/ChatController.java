...
public class ChatController {
    ...
    /****************************************************************
     [Lesson 10] Implementing semantic caching for conversations

     Please uncomment the method `chat()` below and leave the other
     version of the method right above commented out. The version
     below includes the support for semantic caching to reuse previous
     responses for similar or exact queries.
     ***************************************************************/
...
//    }
    ...
    /***************************************************************
     [Lesson 5] Implementing basic RAG with the knowledge base

     Please uncomment the constant `SYSTEM_PROMPT` below leaving the
     other two versions of the constant commented out. The version
     below includes detailed instructions of how to leverage the
     context provided by the RAG augmentor to answer the user's query.
     ***************************************************************/
...
//            """;
    ...
    /***************************************************************
     [Lesson 8] Implementing a few-shot into the system prompt design

     Please uncomment the constant `SYSTEM_PROMPT` below leaving the
     other two versions of the constant commented out. The version
     below includes detailed instructions of how to leverage the
     context provided by the RAG augmentor to answer the user's query,
     as well as few-shot examples of how to pick relevant context.
     ***************************************************************/
